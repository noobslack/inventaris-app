                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input name="merk_type" type="text" class="form-control @error('merk_type') is-invalid @enderror"
                            id="merk_type" required value="{{ old('merk_type', $inventaris->merk_type) }}">
                        @error('merk_type')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input name="bahan" type="text" class="form-control @error('bahan') is-invalid @enderror" id="bahan"
                            required value="{{ old('bahan', $inventaris->bahan) }}">
                        @error('bahan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input name="keterangan" type="text" class="form-control 
                            id="
                            formGroupExampleInput2" value="{{ old('keterangan', $inventaris->keterangan) }}">
